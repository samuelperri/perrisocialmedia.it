// The linework and photo share one source and one rigid pose, including the LCD.
...
export function cameraGeometry(w,h,unused,p){
 ...
 const a=pose(LCD,{x:100/1536,y:70/1024,width:1336/1536,height:836/1024});
 ...
 return {outline:a.camera,photo:a.camera,screen,blend,cameraVisible:p<.78,reveal:ease((p-.30)/.32)};
}
